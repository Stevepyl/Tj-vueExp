<template>
    <va-card gradient color="#e0e5df">
        ...
        <va-card-content style="text-align: left">
            <h1>修改项目信息</h1>
            <div class="course-title">项目名字：{{ this.taskName }}<va-input class="mb-4" v-model="this.taskName"
                    placeholder="请输入修改后的内容" outline />

            </div>
            <div class="course-description">项目描述：{{ this.taskDescription }}<va-input class="mb-4"
                    v-model="this.taskDescription" placeholder="请输入修改后的内容" outline /></div>
    ...
    /> -->
            ...
            <div class="course-semester">项目类型：{{ this.type }}<va-input class="mb-4" v-model="this.type"
                    placeholder="请输入修改后的内容" outline /></div>
            <div class="course-semester">项目文档： </div>
            <div><va-button color="#aaa" style="color: #777" flat
                    @click="uploadModalVisible = !uploadModalVisible">上传</va-button></div>
      ...
      <div class="el-upload__tip">
        jpg/png files with a size less than 500kb
            ...
            <a-modal v-model:visible="visible3" @ok="handleOk3" @cancel="handleCancel3" unmountOnClose
    ...
    <va-button @click="handleClick4" color="#FF0000"
        style="background-color: rgb(0,0,0) text-align:center">点击删除项目</va-button>
