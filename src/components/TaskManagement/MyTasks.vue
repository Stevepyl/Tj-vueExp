        ...
        <va-card>
            ...
            <va-card-content style="text-align: left">
                ...
                <div v-show="!isCalendarView">
                    <div style="font-size: 20px; font-weight: bold; color: #777; height: 40px; line-height: 40px">
                        未完成&nbsp;<va-icon color="#28609d" name="announcement" /></div>
              ...
              >
                <va-card-content style="rgb(60, 60, 60); font-weight: bold">
                  <div style="display: flex">
                    ...
                    <div style="font-size: 20px; font-weight: bold; color: #777; height: 40px; line-height: 40px">
                        已完成&nbsp;<va-icon color="#51b296" name="thumb_up" /></div>
