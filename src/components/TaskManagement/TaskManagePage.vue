<template>
    ...
    <va-card>
        ...
        <va-card-content style="text-align: left">
            <a-modal v-model:visible="displayAnnouncementModalVisible" hide-cancel ok-text="关闭"
                :close="(this.modifyAnnouncementStatus = false)">
                <template #title>
                    {{ modifyAnnouncementStatus ? "修改信息" : displayAnnouncement.name }}
                </template>
                <a-textarea style="margin-bottom: 10px" v-show="!modifyAnnouncementStatus"
                    v-model="this.displayAnnouncement.Description" auto-size readonly />
                <a-textarea style="margin-bottom: 10px" v-show="!modifyAnnouncementStatus"
                    v-model="this.displayAnnouncement.deadline" auto-size readonly />
                ...
                <div v-show="modifyAnnouncementStatus">
                    ...
                    <a-radio-group v-model="this.displayAnnouncement.type" type="button">
                        <a-radio value="0">小型项目</a-radio>
                        <a-radio value="1">大型项目</a-radio>
                    </a-radio-group>
                </div>
                <div style="height: 20px" />
                <a-button style="margin-top: 10px" v-show="!modifyAnnouncementStatus" @click="
...
">
                ...
                <div style="height: 20px" />
                <a-button v-show="modifyAnnouncementStatus" status="danger" @click="deletetask"
                    style="background-color: rgb(0,0,0) text-align:center">删除项目</a-button>
            </a-modal>
            <a-modal v-model:visible="displayAnnouncementModalVisible1" hide-cancel ok-text="关闭"
                ...
                <div>
                    ...
                    <div style="margin-bottom: 5px">
                        <el-upload ref="upload" :action="getUploadUrl()" :headers="headers()" :auto-upload="false"
...
" style="width: 100%">
                        ...
                        <el-table-column align="right">
                            ...
                            <template #default="scope">
                                <a-button @click="handleShowtaskDetail(scope.row)" size="small">查看</a-button>
                                <a-button @click="handleShowtaskDetail1(scope.row)" size="small">上传实验说明文档</a-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </va-card-content>
...
" style="width: 100%">
                        ...
                        <el-table-column align="right">
                            ...
                            <template #default="scope">
                                <a-button size="small" @click="handleShowtaskDetail(scope.row)">查看</a-button>
                                <a-button size="small" @click="handleShowtaskDetail1(scope.row)">上传实验说明文档</a-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </va-card-content>
