        ...
        <el-row :gutter="24">
            ...
            <el-col :span="24">
                <el-card style="margin-bottom: 10px">
                    ...
                    <el-button style="float: right; margin-top: -10px" type="primary" icon="el-icon-plus"
                        :loading="loading" @click="handHandExam()">
                        {{ handleText }}
                    </el-button>
            ...
            <el-col :span="18" :xs="24" style="margin:0 auto;">
                ...
                <el-card class="qu-content" v-for="(item, index) in questionData" :key="index">

                    <p>{{ index + 1 }}.{{ item.questionTitle }} ({{ item.questionscore }}分)</p>
                    <div v-if="item.questionType === 0">
                        <el-radio-group v-model="item.questionanswer" @change="getValue()">

                            <el-radio label="A">A. {{ item.questionSelectA }}
                                <div style="clear: both" />
                            </el-radio>
                            <el-radio label="B">B. {{ item.questionSelectB }}
                                <div style="clear: both" />
                            </el-radio>
                            <el-radio label="C">C. {{ item.questionSelectC }}
                                <div style="clear: both" />
                            </el-radio>
                            <el-radio label="D">D. {{ item.questionSelectD }}
                                <div style="clear: both" />
                            </el-radio>
                    ...
                    <div v-if="item.questionType === 1">
                        ...
                        <el-checkbox-group v-model="item.questionanswer">
                            <el-checkbox label="A">A. {{ item.questionSelectA }}
                                <div style="clear: both" />
                            </el-checkbox>
                            <el-checkbox label="B">B. {{ item.questionSelectB }}
                                <div style="clear: both" />
                            </el-checkbox>
                            <el-checkbox label="C">C. {{ item.questionSelectC }}
                                <div style="clear: both" />
                            </el-checkbox>
                            <el-checkbox label="D">D. {{ item.questionSelectD }}
                                <div style="clear: both" />
                            </el-checkbox>
                        </el-checkbox-group>
                    ...
                    <div v-if="item.questionType === 2">
                        ...
                        <el-input v-model="item.questionanswer" placeholder="Please input" />
    ...
    methods: {
        ...
        handHandExam() {
            for (var item of this.questionData) {
                ...
                if (typeof (item.questionanswer) === "object")
                    item.questionanswer.sort();
