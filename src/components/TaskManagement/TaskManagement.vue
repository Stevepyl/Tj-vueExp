    ...
    <div>
        <div style="margin-bottom: 10px">
            <va-breadcrumbs separator=">">
                ...
                <va-breadcrumbs-item label="实验项目管理" to="/home/coursemanagement" />
            </va-breadcrumbs>
        </div>
        <va-card>
            ...
            <va-card-title style="font-size: 20px">实验项目管理</va-card-title>
            <va-card-content>
                <va-card v-for="(course, index) in courses" :key="index" color="#f2f3f5" gradient
                    ...
                    <va-card-content style="rgb(60, 60, 60); font-weight: bold">
                        <div style="display: flex">
                            ...
                            <div>
                                <va-button @click="switchToCourse(course.id, index)" color="#e0e5df"
...
export default {
    ...
    methods: {
        switchToCourse(courseId, index) {
            ...
            console.log("调用switchToCourse时 index的值是：" + this.idindex)
