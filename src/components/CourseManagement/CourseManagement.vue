<template>
    <div>
        ...
        <va-card>
            ...
            <va-card-content>
                <div style="text-align:left"><a-button v-if="this.identity == 3" @click="add()" color="#e0e5df"
                ...
                <va-card v-for="(teach, index) in teach" :key="index" color="#ac9b91" gradient
                    ...
                    <va-card-content style="rgb(60, 60, 60); font-weight: bold">
                        <div style="display: flex">
                            ...
                            <div>
                                <va-button @click="modifyCourse(teach.id, index, 1)" color="#e0e5df"
