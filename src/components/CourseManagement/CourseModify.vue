        ...
        this.modifystatus == 1 ? "课程信息" : "成员管理"
            ...
            <div v-if="this.modifystatus == 1">
                ...
                <div style="text-align: center">
                    ...
                    <a-button @click="this.modifystatus = 3" color="#e0e5df"
                        style="color: rgb(40, 40, 40)">点击修改</a-button>
                </div>
            ...
            <div v-if="this.modifystatus == 3">
                ...
                <div style="text-align: center">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a-button v-if="this.on == 0" @click="handleClick4" status="danger"
                        style="background-color: rgb(0,0,0) text-align:center">点击删除课程</a-button>
                </div>
            </div>
...
">
                    ...
                    <el-table-column align="right">
                        ...
                        <template #default="scope">
                            <el-button size="mini" type="danger" @click="DropCourse(scope.row)">点击退课</el-button>
                        </template>
                    </el-table-column>
                </el-table>

                <el-table v-show="this.status == 2" :data="
    teacher.filter(
        (data) =>
            !search ||
            data.name.toLowerCase().includes(search.toLowerCase())
...
" style="width: 100%">
                    ...
                    <el-table-column align="right">
                        ...
                        <template #default="scope">
                            <el-button size="mini" type="danger" @click="DropmanageCourse(scope.row)">点击取消授课</el-button>
                        </template>
                    </el-table-column>
                </el-table>
                <div style="height: 20px" />
                <div style="text-align: center">
                    <a-button v-if="this.on == 0" @click="handleClick" color="#e0e5df"
                        style="color: rgb(40, 40, 40)">点击添加教师</a-button>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                    <a-button v-if="this.on == 0" @click="handleClick1" color="#e0e5df"
                        style="color: rgb(40, 40, 40)">点击添加学生</a-button>
                    <div style="height: 20px" />
    ...
    <div>
        <div>
            <a-modal v-model:visible="visible1" @ok="handleOk1" @cancel="handleCancel1" unmountOnClose
                @before-ok="handleBeforeOk1">
                <template #title> 请输入学生id </template>
                <div>
                    <va-input class="mb-4" v-model="this.studentid" placeholder="请输入学生id" outline />
                </div>
            </a-modal>
            ...
            <a-modal v-model:visible="visible" @ok="handleOk" @cancel="handleCancel" unmountOnClose
                ...
                <div>
                    <va-input class="mb-4" v-model="this.teacherid" placeholder="请输入教师id" outline />
                </div>
            </a-modal>
            <div style="height: 10px" />
        </div>

        <a-modal v-model:visible="visible4" @ok="handleOk4" @cancel="handleCancel4" unmountOnClose
