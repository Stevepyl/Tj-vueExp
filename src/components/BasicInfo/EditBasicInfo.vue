<template>
    <div>
        ...
        <a-modal v-model:visible="showModal" hide-cancel="true" @ok="handleModalOk">
            ...
            <el-upload ref="upload" :action="getUploadAvatarUrl()" :auto-upload="false" :data="additionalData()"
                :headers="headers()" style="text-align: center" :before-upload="beforeAvatarUpload">
                <template #trigger>
                        ...
                        <tr>
                            <td style="width: 250px">
                                <va-form @submit.prevent="onSubmit">
                                    ...
                                    <va-button @click="onSubmit"
                                        style="margin-left: 60px; margin-top: 20px;">提交</va-button>
                                </va-form>
                            </td>
                        </tr>
                    </tbody>
