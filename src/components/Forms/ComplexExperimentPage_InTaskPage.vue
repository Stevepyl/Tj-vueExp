<template>
    <div>
        ...
        <va-card>
          ...
          :data="additionalData()"
          /> -->
                <el-upload v-show="!isOverdue()" ref="upload" :action="getFileUploadUrl()" :auto-upload="false"
                    :data="additionalData()" :headers="headers()" style="text-align: center"
                    :on-success="handleOnSuccess" :on-error="handleOnError">
                    <template #trigger>
