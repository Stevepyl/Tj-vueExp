    ...
    <div>
        <div style="margin-bottom: 10px">
            <va-breadcrumbs separator=">">
                ...
                <va-breadcrumbs-item label="查看在线实验报告" disabled />
            </va-breadcrumbs>
        </div>
        ...
        <va-card>
            ...
            <va-card-content>
                ...
                <va-form>
                    ...
                    <a-space>
                        <div>分数</div>
                        <a-input-number style="width: 80%" v-model="markedStudentScore" :min="0" :max="100" />
                        <va-button color="#9fbcc2" gradient @click="updateScore">提交</va-button>
                    </a-space>
                    <div style="height: 30px" />
                </va-form>
            </va-card-content>
